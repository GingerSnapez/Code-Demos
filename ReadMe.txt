...
A program that creates a series of synchorized painters with GUIs in swing, each with a name, a drawing panel, and a chat box. The series of painters connect to each other through a central hub and can be disconnected to run on their own. This was accomplished with a series of sockets and output streams to pass messages and shapes to the other painters and threads to split of processes like listening for updates from the other painters and writting updates to the other painters while running each individual painter and the hub. It was written with Java in Eclipse.
